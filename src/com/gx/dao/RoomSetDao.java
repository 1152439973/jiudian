...
public interface RoomSetDao {
	...
	//分页模糊查询
    public List<RoomSetPo> pageFuzzyselect(@Param("roomNumber")String roomNumber,@Param("currentPage")int currentPage,@Param("pageSize")int pageSize);
    
    //分页模糊查询总条数
    public int countFuzzyselect(@Param("roomNumber")String roomNumber);
