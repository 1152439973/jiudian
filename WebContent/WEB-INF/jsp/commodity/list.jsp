...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" >
    ...
    <div class="span4">
	    <div class="row-fluid">
		    <label class="labelroomnumber" style="font-size:16px;">商品名1：</label>
...
<div class="container" >
 ...
 <div >
       ...
       <button style="margin-top:-23px;" class="btn btn-info btn-small" type="button" onclick="newaddfunction()"><li class="icon-plus icon-white"></li>新增1</button>
    
       <button style="margin-top:-23px;" class="btn btn-danger btn-small" type="button" onclick="newdeletefunction()"><li class="icon-remove icon-white"></li>删除2</button>
    </div>
    <br>
   ...
   var chk_value=[];
  	...
  	if(chk_value!=""){
		if(chk_value.toString().indexOf(",")>0){
		   ...
		   parent.document.getElementById("Mainid").src='${ctx}/Commodity/toupdate.do?id='+chk_value; //跳到控制器
		}
	}else{
	  alert("请选择一条数据进行修改");
	}
