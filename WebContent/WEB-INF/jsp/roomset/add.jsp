...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
	    ...
	    <div class="span12 margin-top-two">
	      <div class="row-fluid">
		      ...
		      <div class="span5">
                  ...
                  <input id="roomNumberId" name="roomNumber" class="textone inputone"style="height:26px;" type="text" onblur="YZ(this.value)"onchange="onchangeOne()"> 
	    ...
	    <div class="span12 margin-top-one">
	      <div class="row-fluid">
		      ...
		      <div class="span5">
			      ...
			      <input id="roomAmountId" type="text"  name="roomAmount" class="textone inputone" style="height:26px;"  onblur="onchangeOne()">
	    ...
	    <div class="span12 margin-top-one" >
	      <div class="row-fluid">
		       ...
		       <div class="span6">
			      ...
			      <input id="standardPriceDayId" name="standardPriceDay"  onblur="onchangeOne()" type="text">
 ...
 <script type="text/javascript">
   ...
   function onchangeOne(){
     //房间号
     if(document.getElementById("roomNumberId").value!=""){
       document.getElementById("divOne").style.display="none";/* 有值的时候哦文本框后面的*就不显示 */
     }else{
       document.getElementById("divOne").style.display="block"; //显示
     }
     ...
     if(document.getElementById("roomAmountId").value!=""){
       ...
       {
          document.getElementById("roomAmountId").focus();   //给这个文本框提供焦点
          document.getElementById("roomAmountId").value="";  //清空文本框
          document.getElementById("divTwo").style.display="block"; //显示*
          alert("床位数:请输入正整数");
       }
       
     }else{
       document.getElementById("divTwo").style.display="block"; //显示*号
     }
